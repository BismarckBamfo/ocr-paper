...
opt = {'number': '0123456789',
'symbol': "!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~ €",
'lang_char': 'ABƆDEFGHIƐKLMNOPQRSTUVWXYZabɔdefghiɛklmnopqrstuvwxyz',
'experiment_name': 'tw_filtered',
'train_data': '../input/d/bismarck91/twi-ocr/trainer/all_data',
'valid_data': '../input/d/bismarck91/twi-ocr/trainer/all_data/tw_val',
'manualSeed': 1111,
'workers': 2,
'batch_size': 32 ,
'num_iter': 10000,
